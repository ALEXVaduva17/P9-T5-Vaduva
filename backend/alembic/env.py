...
It configures the migration context to use the async engine
from app.database and imports all ORM models via Base.metadata.
"""
...
# ── Offline migrations (generates SQL script, no DB connection) ──
